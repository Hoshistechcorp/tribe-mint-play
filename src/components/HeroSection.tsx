    ...
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-background pt-20 pb-10 sm:pt-24 sm:pb-16">
      <div className="container relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            {/* Main card */}
            <div className="bg-card border border-border rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-card">
              {/* Profile */}
              <div className="flex flex-col items-center mb-5 sm:mb-6">
                ...
                <h3 className="text-lg sm:text-xl font-heading font-bold text-foreground">Ada Osei</h3>
              ...
              <div className="bg-muted/50 rounded-xl sm:rounded-2xl p-4 sm:p-5 mb-4 sm:mb-5 text-center">
                ...
                <p className="text-3xl sm:text-4xl font-display italic text-foreground">$2,847</p>
            ...
            {/* Floating notifications - hidden on small mobile, shown from sm up */}
            <motion.div
              animate={{ y: [0, -8, 0] }}
              transition={{ repeat: Infinity, duration: 3 }}
              className="hidden sm:flex absolute -top-4 -left-8 bg-card border border-border px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold shadow-card items-center gap-2"
            >
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute bottom-1/3 -right-8 lg:-right-12 bg-card border border-border px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold shadow-card items-center gap-2"
            >
              <span className="text-base sm:text-lg">🎁</span>
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute bottom-4 -left-4 lg:-left-6 bg-card border border-border px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold shadow-card items-center gap-2"
            >
              <span className="text-base sm:text-lg">📈</span>
              142 clicks today
            </motion.div>
