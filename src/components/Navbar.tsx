    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 backdrop-blur-xl bg-background/80">
      <div className="container flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button className="px-4 py-2 text-sm font-bold bg-gradient-mint text-primary-foreground rounded-lg shadow-mint hover:opacity-90 transition-opacity">
            Start Earning 🚀
          </button>
        </div>
        ...
        {isOpen && (
          ...
          >
            <div className="container py-4 flex flex-col gap-4">
              ...
              <button className="px-4 py-2 text-sm font-bold bg-gradient-mint text-primary-foreground rounded-lg w-full">
                Start Earning 🚀
              </button>
            </div>
          </motion.div>
